...
export default function MobileHeroSection() {
	return (
		<section className="w-full flex flex-col items-start">
			{/* Open To Banner */}
			<div className="reveal inline-flex items-center gap-2 bg-accent-warning text-black px-3 py-1.5 text-caption font-bold uppercase tracking-widest border-[2px] border-border shadow-[2px_2px_0_0_#000] dark:shadow-[2px_2px_0_0_rgba(255,165,0,0.5)] mb-fluid-sm">
