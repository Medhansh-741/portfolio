...
export default function ExperienceCard({ className = "", delay = 0.5, style }: ExperienceCardProps) {
  return (
    <RetroCard
    ...
    >
      ...
      <div>
        ...
        <div className="mt-4 flex flex-col gap-3 font-mono text-[11px]">
            ...
            {profile.experience.map((exp, index) => (
              ...
              >
                <div className="flex items-center gap-2">
                  ...
                  <span className="font-bold uppercase text-foreground">{exp.company.split(" ")[0]}</span>
                </div>
