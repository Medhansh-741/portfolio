          ...
          <div className="space-y-6">
            {profile.education.map((edu, i) => (
              ...
              >
                ...
                <div className="flex-1">
                  <h3 className="font-sans text-base font-bold text-foreground uppercase">{edu.institution}</h3>
                  <p className="text-xs font-bold text-muted-foreground uppercase tracking-wider mt-1">{edu.degree}</p>
                  <span className="text-[10px] text-muted-foreground font-semibold uppercase tracking-wider">{edu.period}</span>
                </div>
              </motion.div>
            ))}
          </div>
