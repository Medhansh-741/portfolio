export const profile = {
  ...
  skills: {
    ...
    "Applied AI": [
      "PyTorch", "LangGraph", "LangChain", "LlamaIndex", "RAG", "AI Agents",
      "Multi-agent Systems", "YOLOv8", "ONNX", "OpenCV", "Sentence Transformers",
      "Embeddings", "Semantic Search", "Prompt Engineering", "Function Calling",
      "Multimodal AI", "NLP",
    ],
    "Data / Infra / MLOps": [
      "ETL Pipelines", "PostgreSQL", "PostGIS", "Vector/Graph Databases (Qdrant, Neo4j)",
      "Redis", "SQLite", "GDAL", "GeoServer", "Martin Tile Server", "OpenLayers",
      "AWS S3", "GCP", "Docker/Podman", "RHEL/Ubuntu",
    ],
  },
  experience: [
    {
      ...
      description: "Building a standalone dataset-quality evaluation toolkit for AIKosh (under MeitY's IndiaAI Mission) — bridging the ICMR MIDAS 2.0 framework gap, slated for production integration by internship end.",
      tech: ["Next.js", "FastAPI", "Celery", "Redis", "Supabase (PostgreSQL)", "AWS S3", "Pydantic", "JWT Auth", "Jinja2", "WeasyPrint"],
      highlights: [
      ...
      offerLetter: "https://drive.google.com/file/d/1Cgofwc6_vKuQzqllqIPQNVs77jcuh2yY/view?usp=sharing",
    },
    {
      company: "ISSA – DRDO",
      role: "Student Trainee, Ministry of Defence",
      period: "May 2026 – Jul 2026",
      description: "Building a self-contained, fully offline GIS platform enabling classified defence environments with no internet access to securely upload, process, and visualize geospatial map data.",
      tech: ["FastAPI", "PostGIS", "GDAL/ogr2ogr", "GeoServer", "Martin Tile Server", "OpenLayers", "Docker/Podman", "RHEL"],
      highlights: [
      ...
      offerLetter: "https://drive.google.com/file/d/1nezLkpd3oL3SE1_Na7hirCbjfAQfT7MQ/view?usp=sharing",
    },
    {
      company: "Geminid Systems",
      role: "Software Development Intern",
      period: "May 2026 – Jun 2026",
      description: "Evaluated enterprise AI toolchains and shipped production integration tests on live Salesforce CRM infrastructure.",
      tech: ["Vanna.ai", "LlamaIndex", "LangChain", "Librosa", "PyDub", "Torchaudio", "Salesforce Apex", "Einstein AI", "Agentforce"],
      highlights: [
      ...
      offerLetter: "https://drive.google.com/file/d/1lYTnTJkTyrEQxvPpDEUys0IicQ8hXsRR/view?usp=sharing",
      completionLetter: "https://drive.google.com/file/d/1zbMoRUmxyGsiUCIy9RY1wZzFcYG-RgKs/view?usp=sharing",
    },
  ],
  projects: [
    {
      ...
      period: "Mar 2026",
      description: "Detects civic issues via CCTV/dashcam, auto-generates complaint tickets, verifies repairs, and retrains itself.",
      tech: ["YOLOv8", "ONNX", "OpenCV", "FastAPI", "PostgreSQL/PostGIS", "Gemini 2.5"],
    ...
    },
    {
      ...
      description: "5-agent pipeline: legal case in — research, strategy, drafted documents, and reasoned explainability out.",
      tech: ["LangGraph", "FastAPI", "Qdrant", "Neo4j", "Redis", "WebSockets", "Celery", "Groq", "Gemini"],
  ...
  achievements: [
    {
      ...
      detail: "Winner in Digital Democracy track; presented JanSamadhan live before senior policy leaders at Bharat Mandapam; project forwarded to central ministries.",
      certificate: "https://drive.google.com/file/d/1q9moT6B-zS8Gpz6VhfLKHbXZnHAJVAzI/view?usp=sharing",
    },
    {
      title: "Prayatna 3.0 Hackathon — Finalist",
      detail: "Built NyayaAI's 5-agent legal AI backend during a 36-hour sprint.",
      certificate: "https://drive.google.com/file/d/1p1OgIIgURi0Z65zSTpsrdA8R18z1nXyv/view?usp=sharing",
    },
  ],
  education: [
    {
