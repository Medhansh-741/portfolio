          ...
          {profile.experience.map((exp, i) => (
            ...
            >
              <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-2 mb-4">
                <div>
                  <h2 className="font-sans text-xl font-bold text-foreground uppercase">{exp.company}</h2>
                  <p className="text-xs font-bold text-muted-foreground uppercase tracking-wider mt-0.5">{exp.role}</p>
                </div>
              ...
              <p className="text-sm text-muted-foreground mb-4 leading-relaxed italic">{exp.description}</p>
